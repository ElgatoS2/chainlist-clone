...
import "./Hero.css";
import ChainListLogo from "../../assets/Images/ChainListLogo.svg";
		...
		<div className="Hero">
			<div className="Hero__Container">
				...
				<button className="button   button1">
					Add Your Network
					<FaPlus className="cross" />
				</button>
				<button className="button button2">
					Add Your RPC <FaPlus className="cross" />
				</button>
				<a
					href="https://github.com/gwilldan/MyChainList"
					target="blank"
					className="Hero__Container-git"
				>
